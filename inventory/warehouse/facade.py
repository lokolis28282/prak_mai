...
class WarehouseFacade:
    ...
    def issue_rows(self, limit: int | None = None) -> list[dict[str, Any]]:
        return _plain(self.issue_writer.repository.list_rows(limit=limit))
    ...
    def get_overview(self, *, include_balance: bool = True) -> dict[str, Any]:
        ...
        return {
            ...
            "recent_issues": self.issue_rows(limit=20),
