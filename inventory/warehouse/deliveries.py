...
class DeliveryReadService:
    ...
    def list_deliveries(self, query: str = "", filters: dict[str, Any] | None = None) -> list[dict[str, Any]]:
        return self.repository.list_deliveries(query or str((filters or {}).get("query") or ""))
    ...
    def get_delivery(self, delivery_id: int) -> dict[str, Any]:
        ...
        return {"delivery": delivery, "lines": self.get_delivery_lines(int(delivery_id))}
