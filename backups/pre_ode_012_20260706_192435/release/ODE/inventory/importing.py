...
FIELD_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "serial_number": ("SN", "S/N", "Серийный номер", "Серийные номера", "Серийник", "serial_number"),
    ...
    "request_number": ("Заявка", "Заявка№", "Заявка №", "request_number"),
    "order_number": ("Заказ", "Заказ№", "Заказ №", "order_number"),
    "plu": ("PLU", "plu"),
