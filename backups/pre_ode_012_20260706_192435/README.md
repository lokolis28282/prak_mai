...
- в `Поставках` сначала загружается CSV снабжения, затем недостающие реквизиты можно заполнить для выбранных строк и принимать оборудование по S/N;
...
Текущий набор содержит 78 тестов, включая CSV и шаблоны, сканирование, поставки, карточки, поиск, массовое списание, отчеты, справочники, баланс, пользователей, роли, резервные копии и журнал действий.
