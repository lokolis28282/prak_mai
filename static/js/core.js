...
let state={equipment:[],operations:[],categories:[],locations:[],stats:{},task_sources:[],task_types:[],work_log_statuses:[],references:[],reference_kinds:{},balance:[],recent_receipts:[],problems:{},problem_counts:{},warehouse_model_options:[],searchRows:[],daily_report_uploads:[],current_user:{},runtime:{}};let currentSection='warehouse';
