...
let sections={home:[['home','ODE']],monitoring:[['monitoring','Состояние']],knowledge:[['knowledge','База знаний']],works:[['worklogs','Журнал работ']],warehouse:[['balance','Карточки оборудования'],['receipt','Приход'],['issue','Расход'],['inventory','Инвентаризация'],['deliveries','Поставки'],['equipment','Перемещения'],['references','Справочники']],reports:[['daily','Ежедневный'],['weekly','Еженедельный'],['journal','Складские операции']],administration:[['admin_users','Пользователи'],['admin_backups','Резервные копии'],['admin_database','Проверка базы'],['problems','Контроль складских данных'],['admin_audit','Журнал действий']],profile:[['profile','Личные данные']]};
