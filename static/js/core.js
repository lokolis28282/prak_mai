...
let sections={home:[['home','ODE']],monitoring:[['monitoring','Состояние']],knowledge:[['knowledge','База знаний']],works:[['worklogs','УВР']],warehouse:[['balance','Карточки оборудования'],['receipt','Приход'],['issue','Расход'],['inventory','Инвентаризация'],['deliveries','Поставки'],['references','Справочники']],reports:[['worklogs','УВР'],['daily','Отчет за смену'],['weekly','Отчет за неделю'],['journal','Складские операции']],administration:[['admin_users','Пользователи'],['admin_backups','Резервные копии'],['admin_database','Проверка базы'],['problems','Контроль складских данных'],['admin_audit','Журнал действий']],profile:[['profile','Личные данные']]};
let state={equipment:[],operations:[],categories:[],locations:[],stats:{},task_sources:[],task_types:[],work_log_statuses:[],references:[],reference_kinds:{},balance:[],recent_receipts:[],recent_issues:[],problems:{},problem_counts:{},warehouse_model_options:[],searchRows:[],daily_report_uploads:[],current_user:{},runtime:{}};let currentSection='warehouse';
