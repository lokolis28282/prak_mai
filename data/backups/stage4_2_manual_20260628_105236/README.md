...
Шаблоны прихода, расхода, логов и готового ежедневного отчета скачиваются из соответствующих вкладок. Пользователь сохраняет Excel-файл как CSV и загружает его в ODE.
...
Текущий набор содержит 40 тестов, включая прежние 32 сценария и проверки пользователей, ролей, хеширования, реального автора, prod-upload и готовых ежедневных отчетов.
