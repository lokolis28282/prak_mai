...
FIELD_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "serial_number": ("SN", "S/N", "Серийный номер", "Серийник", "serial_number"),
    "inventory_number": ("Инв.№", "Инв. №", "Инвентарный номер", "Inventory", "inventory_number"),
    "item_name": ("Наименование", "Название", "Item", "Позиция", "item_name"),
    "quantity": ("Кол-во", "Количество", "Qty", "Кол-во / метраж", "Количество / метраж", "quantity"),
    "vendor": ("Вендор", "Vendor", "vendor"),
    ...
    "request_number": ("Заявка№", "Заявка №", "request_number"),
    "order_number": ("Заказ№", "Заказ №", "order_number"),
    "plu": ("PLU", "plu"),
