...
| `reference_values` | Проекты, объекты, типы, поставщики, вендоры, единицы и справочники задач |
...
Текущий набор содержит 44 теста, включая проверки пользователей, профиля, смены пароля текущего пользователя, обоих форматов даты, CSV-заголовков, ролей, хеширования, реального автора, prod-upload и готовых ежедневных отчетов.
...
- Kaiten, еженедельный отчет и мониторинг пока являются заглушками;
...
Stage 4.2 завершен. Следующие возможные части Stage 4:
...
Эти задачи не входят в Stage 4.2 и требуют отдельного подтверждения.
