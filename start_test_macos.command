...
python3 scripts/create_clean_test_db.py --source data/warehouse_solar.db --output data/warehouse_solar_test_disposable_v1.db --profile empty --overwrite || exit 1
python3 scripts/create_clean_vacations_test_db.py --overwrite || exit 1

echo "Запуск ODE на тестовом контуре..."
ODE_TEST_MODE=1 python3 app.py web --db data/warehouse_test_disposable_v1.db --solar-db data/warehouse_solar_test_disposable_v1.db --vacations-db data/vacations_test_disposable_v1.db --warehouse-contour demo
