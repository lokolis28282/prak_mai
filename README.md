...
- **Мониторинг** — изолированный ручной поиск по hostname, безопасная очистка
  пробелов из вставленного имени, опциональный DCIM collector, маршрутизация по
  hostname/проекту/информационной системе, класс критичности и единый шаблон
  Rooms/письма без автоотправки.
...
Для инженера подготовлено отдельное пошаговое руководство без архитектурного
