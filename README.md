...
После входа основная работа выполняется в разделе `Склад`:
...
Текущий набор содержит 72 теста, включая CSV и шаблоны, сканирование, поставки, карточки, поиск, массовое списание, отчеты, справочники, баланс, пользователей, роли, резервные копии и журнал действий.
