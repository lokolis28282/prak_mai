...
> macOS / Linux · внешние зависимости не требуются · 639 автоматических тестов
...
PNG остаётся историческим снимком 0.18.1 (245 узлов / 502 связи).
Интерактивная карта 0.20.0 актуальна для
текущего дерева и содержит 247 узлов / 506 связей:
...
Текущий discover-набор версии 0.20.0 содержит 639 автоматических тестов
